module github.com/akeylesslabs/sigstore-clone/pkg/signature/kms/akeyless

replace (
	github.com/akeylesslabs/akeyless-go/v3 => /Users/ranisharim/Projects/akeyless-main-repo/go/src/client/sdktest/akeyless-go
